...
const isAdmin = async (req) => {
  ...
  export async function PUT(req, {params}) {
      try {
          ...
          const { email, password, role, applicationStatus , yearOfStudy,hasMedicalCertificate, roomPreferences, roommatePreferences, queueId, notificationSent } = parsedBody.data
           const updatedData  = {
              email,
              role,
              applicationStatus,
